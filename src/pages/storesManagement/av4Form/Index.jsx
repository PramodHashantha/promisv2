...
import ItemsViewAV4 from '@/components/storesManagement/av4Form/ItemsViewAV4';
...
const AV4FormIndex = () => {
  ...
  const handleWarehouseSelect = (warehouse) => {
    console.log('AV4Form: Warehouse selected:', warehouse);
  ...
  const handleRackSelect = (rack) => {
    console.log('AV4Form: Rack selected:', rack);
    ...
    <>
      <PageHeader>
        <div className="store-header-wrapper">
          <h1 className="page-title">AV4 Form - Store Management</h1>
