...
const SupportDetails = () => {
  return (
    <div
      className="offcanvas offcanvas-end topics-details-offcanvas"
      tabIndex={-1}
      id="topicsDetailsOffcanvas"
      ...
      <div className="offcanvas-body">
        <div className="p-lg-5 mx-lg-5 help-center details-content-body">
          ...
          <p className="fs-12 text-muted">
            Last Updates:{" "}
            <span className="text-dark fw-medium">26 May, 2024</span>
          </p>
          <hr className="my-4" />
          <h4 className="fs-14">Hey there...!!!</h4>
          <p className="text-muted">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Assumenda
            consectetur illo at placeat cum nulla repellat expedita nostrum
            praesentium blanditiis repudiandae commodi tempore debitis odio,
            doloremque magni eaque soluta cupiditate ullam harum, necessitatibus
            sunt voluptas eum laboriosam. Consequatur nobis fuga fugiat deleniti
            veritatis sint, suscipit magni tempora labore. Neque, eaque?
          </p>
          <p className="text-muted">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Assumenda
            consectetur illo at placeat cum nulla repellat expedita nostrum
          ...
          <ul className="text-muted my-4">
            <li className="mb-2">
              <strong className="text-dark">Integration</strong> Applications
            </li>
            <li className="mb-2">
              <strong className="text-dark">Integration</strong> Video Tutorials
            </li>
            <li className="mb-2">
              <strong className="text-dark">Step by Step</strong> Intigrations
              Guide
            </li>
            <li className="mb-2">
              <strong className="text-dark">Add favorite</strong> for quick and
              messaging
            </li>
            <li className="mb-2">
              <strong className="text-dark">Fine-tune</strong> your
              notifications to focus on that matters
            </li>
            <li>
              <strong className="text-dark">Trigger your inbox</strong> and own
          ...
          <div className="mt-5">
            ...
            <ul className="list-unstyled">
              ...
              <li className="d-flex align-items-center mb-2">
                ...
                <span>
                  Access and edite bugs reports and create new issues.
                </span>
              </li>
              <li className="d-flex align-items-center mb-2">
                <span className="avatar-text avatar-sm bg-soft-success text-success me-2">
              ...
              <li className="d-flex align-items-center">
                ...
                <span>
                  By clicking allow access, your authorize untitled to access
                  your informations.
                </span>
              </li>
            </ul>
          ...
          <div className="mb-5">
            <pre>
              <code className="language-html">
                ...
                {"    "}&lt;!--! The above 6 meta tags *must* come first in the
          ...
          <p className="text-muted mb-4">
            ...
            officiis minus omnis veniam cupiditate molestiae itaque hic
            quibusdam fuga modi quam cumque recusandae harum nulla vero, tempore
            possimus aliquid animi!
          </p>
          <div className="mb-5">
            <pre>
              <code className="language-js">
                ...
                require('prismjs');{"\n"}
                {"\n"}
                {"                                "}// The code snippet you want
                to highlight, as a string{"\n"}
                {"                                "}const code = `var data =
                1;`;{"\n"}
                {"\n"}
                {"                                "}// Returns a highlighted
                HTML string{"\n"}
                {"                                "}const html =
          ...
          <div className="w-100 p-5 bg-gray-100 text-center">
            ...
            <p className="text-muted">
              Explore some common issues or solutions or get in tuch with us.
            </p>
          ...
          <div className="d-flex justify-content-center mt-5">
            <div className="d-flex align-items-center text-muted">
              ...
              <a
                href="#"
                className="wd-15 ht-15 d-flex align-items-center justify-content-center rounded-3 bg-gray-100 m-1"
              >
          ...
          <div className="mb-4">
            ...
            <p className="fs-12 text-muted">
              6 More topics in this collections
            </p>
          </div>
          <div className="row">
