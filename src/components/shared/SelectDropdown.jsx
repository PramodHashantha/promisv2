...
const SelectDropdown = ({
  ...
  if (loading) {
    return (
      <div className={`select-dropdown ${className ? className : ""}`}>
        <div className="select-box" style={{ padding: 0, border: 'none', background: 'transparent' }}>
  ...
  return (
    <div
      className={`select-dropdown ${className ? className : ""} ${openUpwards ? "open-upwards" : ""
        }`}
      ref={dropdownRef}
    >
