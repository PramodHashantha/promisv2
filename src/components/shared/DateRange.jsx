                        ...
                        showDatePicker && (
                            <div className='date-dropdown'>
                                ...
                                <div className='action-btns'>
                                    ...
                                    <button onClick={() => setToggleDateRange(false)} className='applyBtn brand-btn-danger brand-btn-sm'>Calcel</button>
                                    <button onClick={() => setToggleDateRange(false)} className='applyBtn brand-btn-primary brand-btn-sm'>Applay</button>
                                </div>
                            </div>
                        )
                    }
